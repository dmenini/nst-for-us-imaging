...
stylized = tf.expand_dims(tf_load_image("/scratch/dmenini/nst-for-us-imaging/img/result/perc34.png", 3), 0)
style = tf.expand_dims(tf_load_image('/scratch/dmenini/nst-for-us-imaging/img/style_test/34.png', 3), 0)
